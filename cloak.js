...
function addBtnHome() {
  ...
  if (referrer.indexOf("https://66ezgames.github.io/") !== -1) {
    ...
    e.id = 'inGame';
    e.innerHTML = `
      <img src="nightcore.png" width="300px" height="90px" alt="https://sites.google.com/view/2055-/main-page?authuser=0">`;
    document.getElementsByTagName('body')[0].appendChild(e);
  }
}
...
function returnHome(){
    ...
    var newWindow = window.open("https://sites.google.com/view/2055-/main-page?authuser=0");
    newWindow.document.title = "7https://sites.google.com/view/2055-/main-page?authuser=0";
}
function opendiscord(){
    window.open("https://sites.google.com/view/2055-/main-page?authuser=0");
}
